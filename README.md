...
- 二分查找(bin)  
  ...
  69      求平方根  
- 算法(alg)  
  [146](https://leetcode.cn/problems/lru-cache/)     LRU缓存机制; `LinkedHashMap`  
  [460](https://leetcode.cn/problems/lfu-cache/)      LFU缓存; `3 * map`  
  208     实现Trie(前缀树)  
  1206    实现跳表  
  705     哈希集合  
  706     哈希映射  
